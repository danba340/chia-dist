...
},{"./cjs/react-dom.production.min.js":18,"./cjs/react-dom.development.js":19}],30:[function(require,module,exports) {
/*!
...
var _pricedata = require('../../pricedata.json');

var _pricedata2 = _interopRequireDefault(_pricedata);
...
var baseTarget = _pricedata2.default[0].baseTarget;
console.log(_pricedata2.default);
window.priceData = _pricedata2.default;

var Wrapper = _styledComponents2.default.div(_templateObject);

var Heading = _styledComponents2.default.h1(_templateObject2);

var StorageInput = _styledComponents2.default.input(_templateObject3);

var BaseTargetInput = _styledComponents2.default.input(_templateObject4);

var CoinsPerBlockInput = _styledComponents2.default.input(_templateObject4);

var Result = _styledComponents2.default.div(_templateObject4);

var ProfitCalculator = function (_React$Component) {
  _inherits(ProfitCalculator, _React$Component);

  function ProfitCalculator() {
    _classCallCheck(this, ProfitCalculator);

    var _this = _possibleConstructorReturn(this, (ProfitCalculator.__proto__ || Object.getPrototypeOf(ProfitCalculator)).call(this));
  ...
  _createClass(ProfitCalculator, [{
    key: 'handleChange',
    value: function handleChange(propertyName, event) {
      var calc = this.state.calc;
    ...
    value: function render() {
      return _react2.default.createElement(
        Wrapper,
        { className: 'profit-calc-wrapper' },
        _react2.default.createElement(
          Heading,
          null,
          'Chia Mining Profit Calculator'
        ),
        _react2.default.createElement(
          'div',
          { className: 'row' },
          _react2.default.createElement(
            'div',
            { className: ' column col-6 text-right' },
            _react2.default.createElement(
              'div',
              null,
              'Coins Per Block:'
          ...
          _react2.default.createElement(
            'div',
            { className: 'column col-6 text-left' },
            _react2.default.createElement(CoinsPerBlockInput, { value: this.state.calc.CPB, onChange: this.handleChange.bind(this, 'CPB') }),
            _react2.default.createElement(BaseTargetInput, { value: this.state.calc.BT, onChange: this.handleChange.bind(this, 'BT') }),
            _react2.default.createElement(StorageInput, { value: this.state.calc.S, onChange: this.handleChange.bind(this, 'S') }),
            _react2.default.createElement(
              'div',
              { className: 'result-wrapper' },
              _react2.default.createElement(
                'div',
                { className: 'result' },
                Math.round(20.4 * (3600 * this.state.calc.CPB / (Math.pow(2, 64) / this.state.calc.BT / (4 * this.state.calc.S * 1000000 * 30))))
              ),
              _react2.default.createElement(
                'div',
                { className: 'result' },
...
},{"./../images/blurred-green.jpg":[["b182c6f1f8a82a2bd29d9cfef64e49fa.jpg",10],10],"_css_loader":9}],6:[function(require,module,exports) {
"use strict";
...
var _ProfitCalculator = require("./components/ProfitCalculator.js");

var _ProfitCalculator2 = _interopRequireDefault(_ProfitCalculator);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "svg",
                        { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 371 148" },
                        _react2.default.createElement("path", { fill: "#ffffff", d: "M219.722 46.765h31.856v92.4h-31.856z" }),
                        _react2.default.createElement(
                            "g",
                            { fill: "#ffffff" },
                            _react2.default.createElement("path", { d: "M178.201 43.404c-11.929 0-24.127 2.847-27.164 8.146-.041.067-.081.129-.12.198V13.814H119.06v60.283c3.169 1.447 6.419 3.1 9.707 4.969a157.482 157.482 0 0 1 4.053 2.4c.045.028-18.209 28.365-43.068 34.315-14.687 3.518-32.037-.741-35.552-15.429-.147-.609-.228-1.22-.323-1.83a102.854 102.854 0 0 1 7.145-3.849c6.084-2.643 10.727-4.624 12.484-5.296l.463-.172.009-.001c.002 0 .002-.002.005-.004 14.505-5.244 26.68-7.054 26.68-7.054-11.057-.953-20.551-.185-28.496 1.384-.003-.004-.011-.006-.011-.006s-.06.014-.167.042c-7.194 1.436-13.112 3.525-17.707 5.609 2.56-10.586 11.8-19.783 22.735-22.403a36.83 36.83 0 0 1 3.755-.678 42.382 42.382 0 0 1 2.29-.245c.245-.019.492-.045.738-.058a44.063 44.063 0 0 1 2.956-.089c.194.001.388.012.582.013a50.643 50.643 0 0 1 4.191.233c4.708.485 10.492 1.745 16.904 3.917V49.061a173.88 173.88 0 0 0-9.785-2.714c-8.984-2.386-24.411-4.926-41.283-.829-27.137 6.593-34.833 26.608-34.833 51.066 0 3.116.248 6.032.701 8.775-5.891 3.89-11.677 8.357-16.936 13.455 0 0 7.827-3.48 18.165-8.059 6.901 23.49 30.973 31.392 49.1 31.392 18.904 0 31.04-5.38 45.498-14.373v11.391h31.857V82.66l.12-.223v-.96c3.031-8.076 8.186-10.16 13.915-10.16 7.572 0 12.303 5.361 12.303 13.88v53.968h31.857V76.05c0-19.871-12.46-32.646-30.911-32.646M235.807 5.917c-9.619 0-16.402 6.781-16.402 16.401s6.783 16.4 16.402 16.4 16.403-6.78 16.403-16.4-6.784-16.401-16.403-16.401M357.771 87.96h.039l-.034-40.275h-31.895l-.174 5.725c-30.765-19.76-50.405.561-50.405.561-9.393 8.576-14.844 22.116-14.844 39.117 0 30.141 18.119 48.071 41.673 48.071 8.828 0 16.961-1.994 23.984-11.701.814 2.263 2.626 7.804 3.924 9.707h33.19c-5.689-9.339-5.643-41.722-5.458-51.205m-48.203 27.087c-10.33 0-17.614-8.964-17.614-21.682 0-12.718 7.284-21.684 17.614-21.684 7.244 0 12.986 4.413 15.772 11.434v20.498c-2.785 7.021-8.528 11.434-15.772 11.434" })
                        )
                    )
                ),
                _react2.default.createElement(_ProfitCalculator2.default, null)
            );
        }
    }]);
...
//# sourceMappingURL=/dist/f65cb3ffa9aa28224b6f7410c51a2fa0.map